...
\begin{DoxyCompactList}\small\item\em Return a list of edges traversing from the start to finish. Means of finding the path is implementation-\/specific. \end{DoxyCompactList}\end{DoxyCompactItemize}
